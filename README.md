...
- **Code:** https://github.com/Prashant-thakur77/tapflow · **Narration script:** [`docs/DEMO-SCRIPT.md`](docs/DEMO-SCRIPT.md) · **Demo video:** [`docs/media/tapflow-demo-silent.mp4`](docs/media/tapflow-demo-silent.mp4) (silent walkthrough; narrated cut linked on DoraHacks) · **Telegram bot:** source in [`tg-bot/`](tg-bot/), runs with your own `BOT_TOKEN`
