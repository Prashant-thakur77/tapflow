...
- **Code:** https://github.com/Prashant-thakur77/tapflow · **Narration script:** [`docs/DEMO-SCRIPT.md`](docs/DEMO-SCRIPT.md) · **Demo video:** [youtu.be/xzKF1KN3L9E](https://youtu.be/xzKF1KN3L9E) · [`docs/media/tapflow-demo.mp4`](docs/media/tapflow-demo.mp4) (3 min 44 s, narrated and captioned; a wallet is connected on camera, a session wallet funded and a tap filled, a real same-block mirror placed at block 485621955, and a phone clip places a real order from a Telegram chat) · picture-only cut: [`tapflow-demo-silent.mp4`](docs/media/tapflow-demo-silent.mp4) · **Telegram bot:** [@TapFlowSomniaBot](https://t.me/TapFlowSomniaBot) — live
...
Everything above runs against real Shannon transactions from wallet `0x6798…F228` (leader) and `0x1AD9…2015` (follower). Every contract is subscribed: CopyHandler (sub 16910004) mirrors, RiskGuard (sub 17880662) pauses a follower at their loss cap. The indexer has paired **55 of 55** reactive mirrors with their broadcast in the same block across v1 to v4. 28 filled. The 27 that placed nothing are the honest part: most were the bug v4 fixes (the leader's own order had taken the book at that price), and the proof page now shows the contract's own reason code for each one. Since v4 went live every mirror has filled.
...
| `RiskGuard.subscribe` → reactivity subscription 17880662 (funded with 33 STT) | [`0xe13928…2c95`](https://shannon-explorer.somnia.network/tx/0xe1392861a7e8429a48886ec7fefde40d73cb5ec70d5b49b09849b09d006a2c95) |
...
- **Deployed on Shannon** (`contracts/deployments.json`):
  ...
  | RiskGuard (v4) | [`0x03A52EE60b30537fa57C889795576E63CFCaE3b7`](https://shannon-explorer.somnia.network/address/0x03A52EE60b30537fa57C889795576E63CFCaE3b7) — deployed + wired, triggered by `FollowerCapped`; reactivity subscription 17880662, funded with 33 STT |
